...
party = Party.changeset(%Party{}, %{date: ~U[2023-05-04 21:00:00Z], description: "Cumple de pulga ololo", latitude: -34.561631, longitude: -58.480185, title: "Cumple de pulga", owner: pulga, assisting: [berto], assisting_limit: 5})
        |> Repo.insert!
